...
const ErrorPage = () => {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        ...
        {userInfo?.is_superuser ? (
          <Link to="/admin/dashboard">
            <span
              className="flex items-center space-x-2 bg-sliderBg hover:bg-sliderHover text-gray-100 px-4 py-2 rounded transition duration-150"
              title="Return Home"
            >
              <svg
      ...
      <div className="w-1/2 lg:h-full flex lg:items-end justify-center p-4">
        <svg
          className="w-full text-sliderBg"
          xmlns="http://www.w3.org/2000/svg"
          data-name="Layer 1"
